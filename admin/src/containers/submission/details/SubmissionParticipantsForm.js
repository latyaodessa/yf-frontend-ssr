...

            {
                value.map((p, o) => {
                    return <Form key={o}>
                        <Form.Field>
                            <label>agency</label>
                            <input onChange={e => this.updateNestedField(e, key, o)} name={`agency`} value={p.agency}/>
                        </Form.Field>
                        <Form.Field>
                            <label>city</label>
                            <input onChange={e => this.updateNestedField(e, key, o)} name={`city`} value={p.city}/>
                        </Form.Field>
                        <Form.Field>
                            <label>country</label>
                        ...
                        <Form.Field>
                            <label>vk</label>
                            <input onChange={e => this.updateNestedField(e, key, o)} name={`vk`} value={p.vk}/>
                        </Form.Field>
                        <Form.Field>
                            <label>website</label>
